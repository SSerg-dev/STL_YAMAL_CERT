CREATE TABLE [dbo].[p_TestObject] (
    ...
    [Created_User_ID]  UNIQUEIDENTIFIER DEFAULT ('00000000-0000-0000-0000-000000000000') NOT NULL,
    [Modified_User_ID] UNIQUEIDENTIFIER DEFAULT ('00000000-0000-0000-0000-000000000000') NOT NULL,
