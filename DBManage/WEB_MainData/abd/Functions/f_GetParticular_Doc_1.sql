...
CREATE function [abd].[f_GetParticular_Doc]
(
...
(
	select 
		...
		,DocumentType_Group				= dt.DocumentType_Group
		...
		,dp.Document_Date
	from
	(select DocumentType_ID, DocumentType_Group from abd.p_DocumentType where DocumentType_Code = @DocumentType_Code) dt
