...
-- =============================================
CREATE PROCEDURE  [dbo].[CombineRegisterFromPIP_LOG_OLD] 
(
...
--prepare Piping data R_WorkProgressPipingRegisters
		 ...
		 N'
			...
			DROP TABLE IF EXISTS #Tmp_All_PipngRegs;
			 ...
			 SELECT wpr.LogId, 
			   ...
			   LEFT JOIN '+@MainData+'.dbo.p_Phase as p ON wpr.Phase_ID = p.Phase_ID 
	...
	declare @SQL3 nvarchar(max) = 
		  N'
		    ...
		    LEFT JOIN '+@MainData+'.dbo.p_Phase as p ON wpq.Phase_ID = p.Phase_ID 
