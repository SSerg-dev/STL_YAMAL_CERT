...
create procedure abd.DocumentType_Delete	-- not null ->	+
(	 @i_DocumentType_ID	nvarchar(250)	-- usr param	+
	...
	-- DocumentType
	if (@e = 0) begin try
		update abd.p_DocumentType set RowStatus = @RowStatus, Update_DTS = @u_Update_DTS,Modified_User_ID  = @u_Modified_User_ID where DocumentType_ID = @u_DocumentType_ID
	end try begin catch 
