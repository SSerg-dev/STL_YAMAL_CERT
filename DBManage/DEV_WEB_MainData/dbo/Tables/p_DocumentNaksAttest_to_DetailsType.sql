CREATE TABLE [dbo].[p_DocumentNaksAttest_to_DetailsType] (
    [DocumentNaksAttest_to_DetailsType_ID] UNIQUEIDENTIFIER   DEFAULT (newsequentialid()) NOT NULL,
    ...
    CONSTRAINT [FK_p_DocumentNaksAttest_to_DetailsType_p_DetailsType_DetailsType_ID] FOREIGN KEY ([DetailsType_ID]) REFERENCES [dbo].[p_DetailsType] ([DetailsType_ID]),
    CONSTRAINT [FK_p_DocumentNaksAttest_to_DetailsType_p_DocumentNaksAttest_DocumentNaksAttest_ID] FOREIGN KEY ([DocumentNaksAttest_ID]) REFERENCES [dbo].[p_DocumentNaksAttest] ([DocumentNaksAttest_ID]),
    CONSTRAINT [FK_p_DocumentNaksAttest_to_DetailsType_p_RowStatus_RowStatus] FOREIGN KEY ([RowStatus]) REFERENCES [dbo].[p_RowStatus] ([RowStatus_ID])
);
...
GO
CREATE NONCLUSTERED INDEX [IX_p_DocumentNaksAttest_to_DetailsType_RowStatus]
    ON [dbo].[p_DocumentNaksAttest_to_DetailsType]([RowStatus] ASC);
