...
-- =============================================
CREATE PROCEDURE [dbo].[UserXLSErrorLog_Insert] 
...
SET @Reference_Error = 0
	...
	Select	@x_Count = count(UserTaskLog_ID) from dbo.UserTaskLog where UserTaskLog_ID = @i_UserTaskLog_ID 
	...
	IF @Reference_Error + @User_Error = 0 
		...
		SET @o_DB_New_ID = NEWID()
			...
			Insert into [dbo].[p_UserXLSErrorLog]
