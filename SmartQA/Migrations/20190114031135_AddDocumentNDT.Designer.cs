...
namespace SmartQA.Migrations
{
    ...
    [Migration("20190114031135_AddDocumentNDT")]
    partial class AddDocumentNDT
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDT", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DocumentNDT_ID")
                        .HasDefaultValueSql("newsequentialid()");

                    b.Property<Guid>("Created_User_ID");

                    b.Property<Guid?>("DocumentNDTID");
                    ...
                    b.Property<string>("OrganizationPublishedNDT");
                    ...
                    b.ToTable("p_DocumentNDT");
                });

            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDTIT", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DocumentNDTIT_ID")
                        .HasDefaultValueSql("newsequentialid()");

                    b.Property<Guid>("Created_User_ID");

                    b.Property<Guid>("DocumentNDT_ID");

                    b.Property<DateTimeOffset?>("Insert_DTS")
                        .IsRequired();

                    b.Property<string>("InspectionSubject");

                    b.Property<Guid>("InspectionTechnique_ID");
                    ...
                    b.HasIndex("DocumentNDT_ID");

                    b.HasIndex("InspectionTechnique_ID");
                    ...
                    b.ToTable("p_DocumentNDTIT");
                });

            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDTIT_to_InspectionSubject", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DocumentNDTIT_to_InspectionSubject_ID")
                        .HasDefaultValueSql("newsequentialid()");

                    b.Property<Guid>("Created_User_ID");

                    b.Property<Guid>("DocumentNDTIT_ID");

                    b.Property<DateTimeOffset?>("Insert_DTS")
                        .IsRequired();

                    b.Property<Guid>("InspectionSubject_ID");
                    ...
                    b.HasIndex("DocumentNDTIT_ID");

                    b.HasIndex("InspectionSubject_ID");

                    b.HasIndex("Modified_User_ID");

                    b.HasIndex("RowStatus");

                    b.ToTable("p_DocumentNDTIT_to_InspectionSubject");
                });
            ...
            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDT", b =>
                {
                    ...
                    b.HasOne("SmartQA.DB.Models.PermissionDocuments.DocumentNDT")
                        .WithMany("Inserts")
                        .HasForeignKey("DocumentNDTID");
            ...
            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDTIT", b =>
                {
                    ...
                    b.HasOne("SmartQA.DB.Models.PermissionDocuments.DocumentNDT", "DocumentNDT")
                        .WithMany("DocumentNDTITSet")
                        .HasForeignKey("DocumentNDT_ID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SmartQA.DB.Models.Reftables.InspectionTechnique", "InspectionTechnique")
                        .WithMany()
                        .HasForeignKey("InspectionTechnique_ID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SmartQA.DB.Models.Reftables.Level", "Level")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartQA.DB.Models.PermissionDocuments.DocumentNDTIT_to_InspectionSubject", b =>
                {
                    ...
                    b.HasOne("SmartQA.DB.Models.PermissionDocuments.DocumentNDTIT", "DocumentNDTIT")
                        .WithMany("DocumentNDTIT_to_InspectionSubjectSet")
                        .HasForeignKey("DocumentNDTIT_ID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SmartQA.DB.Models.Reftables.InspectionSubject", "InspectionSubject")
                        .WithMany()
                        .HasForeignKey("InspectionSubject_ID")
                        .OnDelete(DeleteBehavior.Restrict);
